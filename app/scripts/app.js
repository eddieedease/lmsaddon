...
angular
  ...
  .config(function($routeProvider) {
    $routeProvider
      ...
      .when('/ondersteuning', {
        templateUrl: 'views/ondersteuning.html',
        controller: 'OndersteuningCtrl',
        controllerAs: 'ondersteuning'
      })
      .when('/rapporten', {
        templateUrl: 'views/rapporten.html',
        controller: 'RapportenCtrl',
        controllerAs: 'rapporten'
      })
      .otherwise({
        redirectTo: '/'
      });
...
(function(angular) {
  ...
  angular.module("template/multiSelect.html", []).run(["$templateCache", function($templateCache) {
    $templateCache.put("template/multiSelect.html",
      ...
      '<div class="select">' +
      '<label class="control-label" for="multiSelectSelected"><b>{{ selectedLabel }}</b> ' +
      '({{ model.length }})</label>' +
      '<ul>' +
      ...
      '</div>' +
      '<div class="select">' +
      '<label class="control-label" for="multiSelectAvailable"><b>{{ availableLabel }}</b> ' +
